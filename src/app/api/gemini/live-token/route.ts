...
function createSystemInstruction(role: string) {
    ...
    return [
        ...
        "Begruesse knapp und starte dann direkt mit der ersten vorgesehenen Kernfrage.",
        ...
        "Wenn du ein Signal bekommst, dass noch rund 40 Sekunden bleiben, stellst du genau eine letzte kurze Frage und danach keine weitere Frage mehr.",
        "Wenn du ein Signal bekommst, dass noch 15 Sekunden bleiben, unterbrichst du hoeflich sofort, sagst knapp, dass die Zeit vorbei ist, bedankst dich und beendest das Gespraech ohne weitere Frage.",
        "Wenn du ein explizites Wrap-up-Signal, knappe Restzeit oder einen Abschluss-Hinweis bekommst, leitest du sofort den Abschluss ein, stellst keine neue Fachfrage und schliesst in maximal 2 kurzen Saetzen.",
        "Wenn das Ende eingeleitet wird, verabschiedest du dich professionell und stellst keine neue lange Frage mehr.",
